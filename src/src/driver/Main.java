...
public class Main {
   private static Vehicle[] vehicles;
    ...
    public static void main(String[] args) {
        ...
        if(count==0){
            System.out.println("please provide the maximum number of vehicles:");
                ...
                switch (choice) {
                    case 1 -> {
                        ...
                        String EnteredClientName = s.next();
                            for (Client client : clients) {
                                if (client != null) {
                                    if (client.getClientName().equalsIgnoreCase(EnteredClientName)) {
                                            ...
                                            for (Vehicle vehicle : vehicles) {
                                                if (vehicle != null) {
                                                    if (vehicle.getPlateNumber().equalsIgnoreCase(plateNumber)) {
                                                        client.setClientVehicle(vehicle);
                                                    }
                                                }
                    ...
                    case 2 -> {
                        System.out.println("Enter the plate number of the vehicle to return: ");
                        String plateNumber = s.next();
                    ...
                    case 3 -> {
                        ...
                        for (Client client : clients) {
                            if (client != null) {
                                if (client.getClientName().equalsIgnoreCase(clientName1)) {
                                    for (Vehicle vehicle : vehicles) {
                                        if (vehicle != null) {
                                            if (vehicle.getPlateNumber().equalsIgnoreCase(client.getClientVehicle().getPlateNumber())) {
                                                System.out.println(vehicle+client.getClientName());
                                            }
                                        }
                                ...
                                System.out.println("no client found with this name");
                        }
                    }
                    case 4 -> {
                        for (Client client : clients) {
                                for (Vehicle vehicle : vehicles) {
                                    if (vehicle != null && client != null&& client.getClientVehicle()!=null) {
                                        if (vehicle.getPlateNumber().equalsIgnoreCase(client.getClientVehicle().getPlateNumber())) {
                                            System.out.println(vehicle+client.getClientName());
                                        }
                                    }

                                } System.out.println("no registered vehicle or client.");
        ...
        public static  ElectricCar[] deepCopy (ElectricCar[] electricCars){
            ElectricCar[] newCars = new ElectricCar[electricCars.length];
            for (int i = 0; i < electricCars.length; i++) {
